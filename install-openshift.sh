...
export SCRIPT_REPO=${SCRIPT_REPO:="https://raw.githubusercontent.com/dcdh/installcentos/master"}
...
${IP}		$(hostname) console console.${DOMAIN} master.localhost.localdomain
EOD
